...
from amuse.ext.orbital_elements import orbital_elements_from_binary, get_orbital_elements_from_arrays
...
for i in range(n):
    ...
    # plt.savefig("scatter_plot_system_t_end={}yr_n={}_i={}_z={}.png".format(t_end.value_in(units.yr), n, i, z))
    # plt.close()
